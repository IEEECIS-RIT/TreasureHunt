...
function checkWinLose(guess, tiles) {
  if (guess === targetWord) {
    document.querySelector(".heading").innerHTML = "https://bit.ly/3QhSfnl";
    document.querySelector(".res").className += " fade";
    document.querySelector(
      ".res"
    ).innerHTML = `<a href="https://friendlyhelicopter.netlify.app/"><img src="https://i.imgflip.com/6j880n.jpg" title="https://friendlyhelicopter.netlify.app/"/></a>`;
